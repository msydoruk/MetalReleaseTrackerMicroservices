using AutoMapper;
using MassTransit;
using MetalReleaseTracker.CoreDataService.Configurations;
...
public class AlbumParsedEventConsumerTests : IClassFixture<TestPostgresDatabaseFixture>
{
    ...
    public async Task Consume_WhenConsumingNewAlbum_ShouldAddAlbumToDatabase()
    {
        ...
        // Assert
        var newAlbum = await _albumRepository.Get(albumProcessedPublicationEvent.Id);
    ...
    public async Task Consume_WhenConsumingUpdatedAlbum_ShouldUpdateAlbumToDatabase()
    {
        ...
        // Assert
        var existingAlbum = await _albumRepository.Get(albumProcessedPublicationEvent.Id);
    ...
    public async Task Consume_WhenConsumingDeletedAlbum_ShouldDeleteAlbumFromDatabase()
    {
        ...
        // Assert
        var deletedAlbum = await _albumRepository.Get(albumProcessedPublicationEvent.Id);
