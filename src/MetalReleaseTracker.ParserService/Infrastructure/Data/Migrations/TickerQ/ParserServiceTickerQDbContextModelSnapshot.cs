...
namespace MetalReleaseTracker.ParserService.Infrastructure.Data.Migrations.TickerQ
{
    ...
    partial class ParserServiceTickerQDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MetalReleaseTracker.ParserService.Infrastructure.Data.Entities.CustomCronTicker", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MetalReleaseTracker.ParserService.Infrastructure.Data.Entities.CustomTimeTicker", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TickerQ.Utilities.Entities.CronTickerOccurrenceEntity<MetalReleaseTracker.ParserService.Infrastructure.Data.Entities.CustomCronTicker>", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MetalReleaseTracker.ParserService.Infrastructure.Data.Entities.CustomTimeTicker", b =>
                {
                    b.HasOne("MetalReleaseTracker.ParserService.Infrastructure.Data.Entities.CustomTimeTicker", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("TickerQ.Utilities.Entities.CronTickerOccurrenceEntity<MetalReleaseTracker.ParserService.Infrastructure.Data.Entities.CustomCronTicker>", b =>
                {
                    b.HasOne("MetalReleaseTracker.ParserService.Infrastructure.Data.Entities.CustomCronTicker", "CronTicker")
                        .WithMany()
